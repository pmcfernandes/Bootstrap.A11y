...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /productName "Bootstrap.A11y" /mediaBookList "Bootstrap.A11y"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Vendor Name" /productName "Bootstrap.A11y" /bookList "Bootstrap.A11y"
