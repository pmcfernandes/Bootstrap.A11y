...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /productName "Tie.Controls.Bootstrap.ARIA" /mediaBookList "Tie.Controls.Bootstrap.ARIA"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Vendor Name" /productName "Tie.Controls.Bootstrap.ARIA" /bookList "Tie.Controls.Bootstrap.ARIA"
